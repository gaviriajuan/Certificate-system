        ...
        <!--<div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <h1>Hola Mundo EPS</h1>
                    <p v-for="(objeto,index) in salud" :key="index">
                    {{objeto.name}}
                    </p>
                </div>
            </div>
...
<div class="overflow-x-auto" v-if="modal" >
      ...
      <div class="flex flex-col w-11/12 sm:w-5/6 lg:w-1/2 max-w-2xl mx-auto rounded-lg border border-gray-300 shadow-xl">
       ...
       <div class="flex flex-col space-y-2">
        ...
        />
        <label for="default" class="text-gray-700 select-none font-medium">Seleccione EPS</label>
                ...
                <option value="0">Coomeva</option>
                <option value="0">Sanitas</option>
                <option value="0">Savia</option>
          ...
          <div class="bg-white shadow-md rounded my-6">
            ...
            <table class="min-w-max w-full table-auto">
              ...
              <tbody class="text-gray-600 text-sm font-light">
                <tr v-for="(objeto, index) in salud" :key="index">
...
export default defineComponent({
  ...
  methods: {
    ...
    listarDatos(){
      let me=this;
      var url="/api/salud/index";

      axios.get(url)
      .then(function(response){
        var respuesta=response.data;
        me.arrayDatos=respuesta.salud;
      })
      .catch(function(error){
      })
    },
