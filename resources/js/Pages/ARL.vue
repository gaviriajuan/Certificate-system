        ...
        <!--<div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <h1>Hola Mundo ARL</h1>
                    <p v-for="(objeto,index) in auxilio" :key="index">
                    {{objeto.name}}
                    </p>
                </div>
            </div>
...
<div class="overflow-x-auto" v-if="modal" >
      ...
      <div class="flex flex-col w-11/12 sm:w-5/6 lg:w-1/2 max-w-2xl mx-auto rounded-lg border border-gray-300 shadow-xl">
       ...
       <div class="flex flex-col space-y-2">
        ...
        />
        <label for="default" class="text-gray-700 select-none font-medium">Seleccione ARL</label>
                ...
                <option value="0">Colmena</option>
                <option value="0">Bolivar</option>
          ...
          <div class="bg-white shadow-md rounded my-6">
            ...
            <table class="min-w-max w-full table-auto">
              ...
              <tbody class="text-gray-600 text-sm font-light">
                <tr v-for="(objeto, index) in auxilio" :key="index">
...
export default defineComponent({
  ...
  methods: {
    ...
    update(){
      let me=this;
      var url="/api/auxilio/actualizar";
      axios.put(url, {
        id:this.idauxilio,
        name:this.nombre.toUpperCase(),
        state:this.edo
    ...
    listarDatos(){
      let me=this;
      var url="/api/auxilio/index2";

      axios.get(url)
      .then(function(response){
        var respuesta=response.data;
        me.arrayDatos=respuesta.auxilio;
      })
      .catch(function(error){
      })
    },
