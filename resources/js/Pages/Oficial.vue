        ...
        <!--<div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <h1>Hola Mundo Oficial</h1>
                    <p v-for="(objeto,index) in offi" :key="index">
                    {{objeto.name}}
                    </p>
                </div>
            </div>
  ...
  <div class="overflow-x-auto" v-if="modal" >
      ...
      <div class="flex flex-col w-11/12 sm:w-5/6 lg:w-1/2 max-w-2xl mx-auto rounded-lg border border-gray-300 shadow-xl">
       ...
       <div class="flex flex-col space-y-2">
        ...
        <label for="default" class="text-gray-700 select-none font-medium">Seleccione</label>
      ...
      >
        <div class="w-full lg:w-5/6">
          <div class="bg-white shadow-md rounded my-6">
            <button @click="abrirModal" class="py-2 px-5 bg-gradient-to-r from-indigo-500 to-yellow-500  focus:outline-none text-white   ">NUEVO</button>
            <table class="min-w-max w-full table-auto">
              ...
              <tbody class="text-gray-600 text-sm font-light">
                <tr v-for="(objeto, index) in offi" :key="index">

                  

                  <td class="py-3 px-6 text-left ">
                    <div class="flex items-center">
                      <span v-text="objeto.names"></span>
                    </div>
                  </td>

                  <td class="py-3 px-6 text-left ">
                    <div class="flex items-center">
                      <span v-text="objeto.surnames"></span>
                    </div>
                  </td>

                  <td class="py-3 px-6 text-left ">
                    <div class="flex items-center">
                      <span v-text="objeto.doc_number"></span>
                    </div>
                  </td>

                  <td class="py-3 px-6 text-left ">
                    <div class="flex items-center">
                      <span v-text="objeto.email"></span>
                    </div>
                  </td>
                  ...
                  <td class="py-3 px-6 text-left ">
                    <div class="flex items-center">
                      <span v-text="objeto.phone"></span>
                    </div>
                  </td>

                  <td class="py-3 px-6 text-left ">
                    <div class="flex items-center">
                      <span v-text="objeto.address"></span>
                    </div>
                  </td>
...
export default defineComponent({
  ...
  methods: {
    ...
    listarDatos(){
      let me=this;
      var url="/api/offi/index";

      axios.get(url)
      .then(function(response){
        var respuesta=response.data;
        me.arrayDatos=respuesta.offi;
      })
      .catch(function(error){
      })
    },
