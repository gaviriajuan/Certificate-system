    ...
    <app-layout title="Dashboard">
        ...
        <!--<div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <h1>Hola Mundo Tipos de Contrato</h1>
                    <p v-for="(objeto,index) in tcontract" :key="index">
                    {{objeto.name}}
                    </p>
                </div>
            </div>
...
<div class="overflow-x-auto" v-if="modal" >
      ...
      <div class="flex flex-col w-11/12 sm:w-5/6 lg:w-1/2 max-w-2xl mx-auto rounded-lg border border-gray-300 shadow-xl">
       ...
       <div class="flex flex-col space-y-2">
        ...
        />
        <label for="default" class="text-gray-700 select-none font-medium">Seleccione tipo de contrato</label>
                ...
                <option value="0">Obra o Labor</option>
                <option value="0">Prestación de servicios</option>
          ...
          <div class="bg-white shadow-md rounded my-6">
            ...
            <table class="min-w-max w-full table-auto">
              ...
              <tbody class="text-gray-600 text-sm font-light">
                <tr v-for="(objeto, index) in tcontract" :key="index">
...
export default defineComponent({
  ...
  methods: {
    ...
    registrar(){     
      let me=this;
      var url="/api/tcontract/registrar";
      axios.post(url, {
    ...
    update(){
      let me=this;
      var url="/api/tcontract/actualizar";
      axios.put(url, {
        id:this.idtcontract,
        name:this.nombre.toUpperCase(),
        state:this.edo
    ...
    delete(){
      let me=this;
      var url="/api/tcontract/eliminar" ;
      axios.post(url,{
        id:this.idtcontract
      })
      .then(function(response) {
    ...
    listarDatos(){
      let me=this;
      var url="/api/tcontract/index2";

      axios.get(url)
      .then(function(response){
        var respuesta=response.data;
        me.arrayDatos=respuesta.tcontract;
      })
      .catch(function(error){
      })
    },
